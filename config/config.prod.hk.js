...
exports.redis = {
  client: {
    port: 6379,
    host: 'r-j6ci9vjmk4yj1uy6zv.redis.rds.aliyuncs.com',
...
exports.rocketMq = {
  ...
  javaChannel: {
    ...
    // 消费者group
    consumerGroup:
      'MQ_INST_1782728101358463_BbujeA0E%GID-TCP-bs-ccr-consumer-response-symbol-trade-info',
    // 消费者topic
    topic_sub:
      'MQ_INST_1782728101358463_BbujeA0E%bs-ccr-topic-response-symbol-trade-info',
    // 生产者topic
    topic_pub: 'MQ_INST_1782728101358463_BbujeA0E%bs-ccr-topic-symbol-price',
    nameSrv:
      'MQ_INST_1782728101358463_BbujeA0E.cn-hongkong.mq-internal.aliyuncs.com:8080',
  },
  // 与国内egg 订单组相关
